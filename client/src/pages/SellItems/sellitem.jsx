  ...
  return (
    ...
    <Toaster position="top-center"></Toaster>
      ...
      <div className={Style.topdiv}>
        ...
        <form className="w-[90vw] mx-auto h-[80vh] flex flex-col items-center justify-center "  onSubmit={formik.handleSubmit}>
         ...
         <TyreSize/>
          <input type="text" placeholder="Brand" {...formik.getFieldProps('brand')} className={Style.input}/>
          <input type="text" placeholder="Price" {...formik.getFieldProps('price')} className={Style.input}/>
          <input type="text" placeholder="Location" {...formik.getFieldProps('location')} className={Style.input}/>
     
          <textarea name="" {...formik.getFieldProps('description')} id="" cols="20" rows="10" placeholder="Description" className={`${Style.input} h-20 min-w-[300px] w-[50%]`}></textarea>
         ...
         <button type="submit" className="bg-yellow-400 px-4 text-xl py-2 m-2 mx-auto rounded-lg  w-[300px] text-black">
